var calculator = function() { 
    ...
    setTimeout(function(){ 
    this.result=555;console.log(this.result)}, 5000) 
    return this; 
    } 
    ...
    engineerCalc.prototype.firstEngineerCalculation=function(number){ 
    console.log("firstEngineerCalculation with number "+ number); 
    return this 
    } 
    ...
    financial_engineerCalc.prototype.firstFinancialEngineerCalculation=function(number1,number2){ 
    console.log("first financial_engineerCalculation with numbers "+ number1+" "+ number2); 
    return this 
    } 
    
    financial_engineerCalc.prototype.secondFinancialEngineerCalculation=function(number1,number2){ 
    console.log("second financial_engineerCalculation with numbers "+ number1+" "+ number2); 
    return this 
    } 
    
    var newEngineerCalc=new engineerCalc(); 
    newEngineerCalc.add(5) 
    .subtract(10) 
    .multiply(-10) 
    .divide(4) 
    .resetResult() 
    ...
    .setState(777) 
    .getResult() 
    .firstEngineerCalculation(10) 
    .secondEngineerCalculation(555); 
    
    var newFinancialEngineerCalc=new financial_engineerCalc(); 
    newFinancialEngineerCalc.add(50) 
    .subtract(10) 
    .multiply(-5) 
    .divide(2) 
    .getResult() 
    .Fetch() 
    .firstEngineerCalculation(15) 
    .secondEngineerCalculation(17) 
    .firstFinancialEngineerCalculation(100,300) 
